...
import { Observable, ObservedValueOf, shareReplay, Subject } from 'rxjs';
...
export class TarjetaService {
  ...
  obtenerTarjetas(): Observable<any> {
    return this.firestore.collection('tarjetas', ref => ref.orderBy('fechaCreacion')).snapshotChanges();
  }
